...
kicker: Module 3 · internal
standfirst: >
  Every activity variant built for Module 3, three per part, with the one wired into each page marked and the reasoning stated. This page is unlisted.
...
{% activity "p1a-four-readings.html", "Four readings", "760px" %}
...
{% activity "p2a-first-look.html", "First look", "800px" %}
...
### C · Where the flag stops working

{% activity "p3c-threshold.html", "Where the flag stops working", "420px" %}
...
### B · The map with holes

{% activity "p4b-map-with-holes.html", "The map with holes", "640px" %}

### C · The satellite clinic

{% activity "p4c-satellite-clinic.html", "The satellite clinic", "620px" %}
...
{% activity "p5b-claim-chain.html", "The claim chain", "640px" %}

### C · Four sentences

{% activity "p5c-four-sentences.html", "Four sentences", "1000px" %}
